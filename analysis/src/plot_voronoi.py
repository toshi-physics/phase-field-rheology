...
args = sys.argv
if (len(args) != 23):
    print("usage: plot_voronoi.py npoints lx ly xbuff ybuff Dr dt data_col data_label data_min data_max tic_start tic_end tic_inc tstart tend tinc make_movie print_to_screen pos_file data_file out_file")
    sys.exit(1)
...
if (use_cbar):
    ...
    cbar.ax.set_ylabel(r"{:s}".format(data_label), fontsize=fontsize, 
                       rotation=270)
